...
function About() {
  ...
  return (
    <Section
      id="about"
      className="bg-[#e2e8f0] text-[#27272a] xl:z-40 relative"
    >
      <div className="flex justify-center items-center flex-col gap-6  md:flex-row lg:justify-start lg:items-start lg:w-3/5 lg:flex-col xl:w-2/5">
      ...
      <div className="lg:flex lg:flex-col gap-10 items-center justify-center w-full lg:w-2/5  xl:absolute xl:-right-[500px] xl:w-max ">
        ...
        <div className="flex flex-col gap-4 items-stretch justify-center relative min-h-[425px] w-full  xl:left-0 xl:flex-row">
          {timelines.map((time) => (
            <Card
              key={time.id}
